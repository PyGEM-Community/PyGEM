...
def prec_biasadj_opt1(
    ...
    outlier_replacement = gcm_prec_annual_norm_repeated * np.tile(
        ref_prec_monthly_avg, int(gcm_prec_biasadj.shape[1] / 12)
    )
    gcm_prec_biasadj[gcm_prec_biasadj > gcm_prec_max_check_adj] = outlier_replacement[
        gcm_prec_biasadj > gcm_prec_max_check_adj
    ]
