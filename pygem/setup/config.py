...
class ConfigManager:
    ...
    EXPECTED_TYPES = {
        ...
        'calib.MCMCTADJ_params.tadj_disttype': str,
        'calib.MCMCTADJ_params.tadj_mu': (int, float),
        'calib.MCMCTADJ_params.tadj_sigma': (int, float),
        'calib.MCMCTADJ_params.tadj_bndlow': (int, float),
        'calib.MCMCTADJ_params.tadj_bndhigh': (int, float),
        'calib.MCMCTADJ_params.kp_ddfsnow_prior_relpath': (str, type(None)),
        'calib.MCMCTADJ_params.overwrite_calib': bool,
        'calib.data': dict,
        ...
        'calib.data.scaf_1d': dict,
        'calib.data.scaf_1d.scaf_1d_relpath': (str, type(None)),
        'sim': dict,
